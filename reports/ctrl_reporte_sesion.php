...
$pk_sesion=$_GET['pk_sesion'];
    ...
    $biblio_docente=$fila['biblio_docente'];
    $biblio_estudiante=$fila['biblio_estudiante'];
...
<tr>
    <td rowspan="2"><span class="b">Inicio</span></td>
    <td><span class="bb">Estrategias:</span> <span class="b">'.$inicio_estrategia.'</span></td>
    <td rowspan="2">iconos</td>
...
<tr>
    <td rowspan="2"><span class="b">Desarrollo</span></td>
    <td><span class="bb">Estrategias:</span> <span class="b">'.$desarrollo_estrategia.'</span></td>
    <td rowspan="2">iconos</td>
    <td rowspan="2">60min.</td>
</tr>
<tr>
    <td valign="top">El estudiante recibe una lectura sobre &ldquo;Conociendo la Computadora&rdquo;</td>
</tr>
<tr>
    <td rowspan="2"><span class="b">Cierre</span></td>
    <td><span class="bb">Estrategias:</span> <span class="b">'.$cierre_estrategia.'</span></td>
    <td rowspan="2">iconos</td>
    <td rowspan="2">20min.</td>
</tr>
<tr>
    <td valign="top">
        A manera de síntesis docente y estudiantes    realizan una
    </td>
</tr>
</table>
';
...
<tr>
    <td valign="top">'.$biblio_docente.'</td>
    <td valign="top">'.$biblio_estudiante.'</td>
</tr>
</table>
';
